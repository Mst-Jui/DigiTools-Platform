    ...
    <div className='w-full bg-linear-to-r from-[#4F39F6] to-[#9514FA] mt-20 py-20'>
      <div className='max-w-6xl mx-auto'>
        <div className='text-center space-y-4'>
          ...
          <div className='flex gap-6 items-center justify-center mt-10 mb-4'>
            <button className="btn bg-white text-[#4F39F6] shadow-none rounded-full font-semibold">Explore Products</button>
           
            <button className="btn btn-outline border-white text-white btn-primary rounded-full font-semibold hover:bg-white hover:text-[#4F39F6]">View Pricing</button>
